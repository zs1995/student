...
CDataTable* CDBConnection::Execute(const char* strCommand)
{
	...
	try
	{
		...
		//获取列数
		m_DbPool.CheckErr(OCIAttrGet((dvoid*)phStmt, OCI_HTYPE_STMT, (dvoid*)&iFileds, (size_t *)0, OCI_ATTR_PARAM_COUNT, m_DbPool.errhp));
...
//			*(indp+i) = 0;
			...
			m_DbPool.CheckErr(OCIAttrGet((dvoid*)pRaram, OCI_DTYPE_PARAM, (dvoid**)&iType, 0, OCI_ATTR_DATA_TYPE, m_DbPool.errhp));
			m_DbPool.CheckErr(OCIAttrGet((dvoid*)pRaram, OCI_DTYPE_PARAM, (dvoid*)&iColLen, 0, OCI_ATTR_DATA_SIZE, m_DbPool.errhp));
